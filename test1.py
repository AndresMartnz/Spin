...
omega_c = 2 * np.pi * (2.7340526876318556 - 20.0e-3)  # Resonator frequency
r_line = 75.0e-6
...
couplings = np.logspace(2, 3, N_coup)  # Spin-photon couplings expressed in Hz
...
pot = -15.0  # Power of the input pulses
omega_driving = omega_s  # Driving frequency for the input pulse
tp_list = np.arange(0, 1001, 25)  # Pulse lengths
